...
contract Beter {
    ...
    constructor(string memory _colorChosen, uint8 _numChosen, bool _winning, string memory _winner) {
        console.log("Deploying a Beter with Beting:", _colorChosen);
        console.log("Deploying a Beter with Beting:", _numChosen);
    ...
    function Bet() public view returns (string memory, string memory) {
        ...
        message = string.concat("Winning Color: ", winningColor, " ", winner);
    ...
    function setBeting(string memory _colorChosen, uint8 _numChosen) public {
        console.log("Changing Beting from '%s' to '%s'", colorChosen, _colorChosen);
        colorChosen= _colorChosen;

        console.log("Changing Beting from '%s' to '%s'", numChosen, _numChosen);
        numChosen = _numChosen;
